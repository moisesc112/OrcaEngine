...
void Application::initWindow() {
	...
	glfwSetFramebufferSizeCallback(window, Application::framebufferResizeCallback);
}
...
void Application::initContext() 
{
	...
	msaaSamples = vulkanContext.getMsaaSamples();
}
...
void Application::createGraphicsPipeline() {
	auto vertShaderCode = Application::readFile("C:/Users/moise/Documents/VS_projects/OrcaEngine/shaders/vert.spv");
	auto fragShaderCode = Application::readFile("C:/Users/moise/Documents/VS_projects/OrcaEngine/shaders/frag.spv");
...
void Application::cleanupColorDepthResources()
{
