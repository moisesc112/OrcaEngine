// OrcaEngine.cpp : Defines the entry point for the application.
//
...
private:
	...
	void createGraphicsPipeline() {
		auto vertShaderCode = readFile("C:/Users/moise/Documents/VS_projects/OrcaEngine/shaders/vert.spv");
		auto fragShaderCode = readFile("C:/Users/moise/Documents/VS_projects/OrcaEngine/shaders/frag.spv");
	...
	void createDepthResources() {
		...
		createImage(swapChainExtent.width, swapChainExtent.height, mipLevels, msaaSamples, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
